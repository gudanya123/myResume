...
var L2Dwidget = function (t) {
    ...
    return r.e = function (t) {
        ...
        c.type = "text/javascript", c.charset = "utf-8", c.async = !0, c.timeout = 12e4, r.nc && c.setAttribute(
            "nonce", r.nc), c.src = r.p + "L2Dwidget." + t + ".min.js";
    ...
    e(2).inspectSource = function (t) {
        ...
        s && (i(e, "name") || r(e, "name", n)), t[n] !== e && (s && (i(e, c) || r(e, c, t[n] ? "" +
            t[n] : u.join(String(n)))), t === o ? t[n] = e : a ? t[n] ? t[n] = e : r(t, n,
                e) : (delete t[n], r(t, n, e)))
    ...
    var o = e(1),
        ...
        u = function (t, n, e) {
            var s, f, l, p, d = t & u.F,
                ...
                y = t & u.P,
                m = t & u.B,
                b = v ? o : h ? o[n] || (o[n] = {}) : (o[n] || {}).prototype,
                g = v ? r : r[n] || (r[n] = {}),
                w = g.prototype || (g.prototype = {});
            for (s in v && (e = n), e) l = ((f = !d && b && void 0 !== b[s]) ? b : e)[s], p = m && f ? a(l,
                o) : y && "function" == typeof l ? a(Function.call, l) : l, b && c(b, s, l, t & u.U), g[
                s] != l && i(g, s, p), y && w[s] != l && (w[s] = l)
        };
    ...
    t.exports = function (t) {
        var n, e, c;
        return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof (e = function (t,
            n) {
            try {
                return t[n]
            } catch (t) { }
        }(n = Object(t), r)) ? e : i ? o(n) : "Object" == (c = o(n)) && "function" == typeof n.callee ?
            "Arguments" : c
    }
}, function (t, n, e) {
    var o = e(2),
        ...
        u = new (function () {
            ...
            return o(t, [{
                ...
                value: function (t, n) {
                    ...
                    return this.eventHandlers[t] || (this.eventHandlers[t] = []), this.eventHandlers[
                        t].push(n), this
                }
            }, {
                key: "emit",
                value: function (t) {
                    for (var n = arguments.length, e = Array(n > 1 ? n - 1 : 0), o = 1; o <
                        n; o++) e[o - 1] = arguments[o];
                    return this.eventHandlers[t] && this.eventHandlers[t].forEach(
                        function (t) {
                            "function" == typeof t && t.apply(void 0, e)
                        }), this.eventHandlers["*"] && this.eventHandlers["*"].forEach(
                            function (n) {
                ...
                value: function () {
                    var t = this,
                        n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[
                            0] : {};
                    (0, i.configApplyer)(n), this.emit("config", this.config), !i.config
                        .mobile.show && r.default.mobile() || e.e(0).then(e.bind(null,
                            79)).then(function (n) {
                                (a = n).theRealInit(t)
                            }).catch(function (t) {
                                console.error(t)
                ...
                value: function () {
                    this.captureFrame(function (t) {
                        ...
                        document.body.appendChild(n), n.setAttribute("type",
                            "hidden"), n.href = t, n.download =
                            "live2d.png", n.click()
                    })
                }
            }]), t
    ...
    t.exports = function (t, n, e, v, h, y, m) {
        ...
        var b, g, w, x = function (t) {
            ...
            k = !1,
            S = t.prototype,
            O = S[l] || S["@@iterator"] || h && S[h],
            j = O || x(h),
            T = h ? P ? x("entries") : j : void 0,
            L = "Array" == n && S.entries || O;
        if (L && (w = f(L.call(new t))) !== Object.prototype && w.next && (s(w, _, !0), o || "function" ==
            typeof w[l] || c(w, l, d)), P && O && "values" !== O.name && (k = !0, j = function () {
                return O.call(this)
            }), o && !m || !p && !k && S[l] || c(S, l, j), a[n] = j, a[_] = d, h)
            if (b = {
                values: P ? j : x("values"),
                keys: y ? j : x("keys"),
                entries: T
    ...
    p && d || (p = function (t) {
        ...
        h.now(c(b, t, 1))
    } : v ? (i = (r = new v).port2, r.port1.onmessage = g, o = c(i.postMessage, i, 1)) : f.addEventListener &&
        "function" == typeof postMessage && !f.importScripts ? (o = function (t) {
            f.postMessage(t + "", "*")
        }, f.addEventListener("message", g, !1)) : o = "onreadystatechange" in s("script") ? function (
            t) {
    ...
    var a = window.document.documentElement,
        ...
        s = ["googletv", "viera", "smarttv", "internet.tv", "netcast", "nettv", "appletv", "boxee", "kylo",
            "roku", "dlnadoc", "pov_tv", "hbbtv", "ce-html"];
    function f(t) {
    ...
    function v() {
        i.landscape() ? (d("portrait"), p("landscape"), h("landscape")) : (d("landscape"), p("portrait"), h(
            "portrait")), b()
    }
    function h(t) {
    ...
    i.macos = function () {
        ...
        return i.androidPhone() || i.iphone() || i.ipod() || i.windowsPhone() || i.blackberryPhone() ||
            i.fxosPhone() || i.meego()
    }, i.tablet = function () {
        ...
        return screen.orientation && Object.prototype.hasOwnProperty.call(window, "onorientationchange") ?
            screen.orientation.type.includes("portrait") : window.innerHeight / window.innerWidth > 1
    }, i.landscape = function () {
        return screen.orientation && Object.prototype.hasOwnProperty.call(window, "onorientationchange") ?
            screen.orientation.type.includes("landscape") : window.innerHeight / window.innerWidth < 1
    }, i.noConflict = function () {
        return window.device = r, this
    }, i.ios() ? i.ipad() ? p("ios ipad tablet") : i.iphone() ? p("ios iphone mobile") : i.ipod() && p(
        "ios ipod mobile") : i.macos() ? p("macos desktop") : i.android() ? i.androidTablet() ? p(
            "android tablet") : p("android mobile") : i.blackberry() ? i.blackberryTablet() ? p(
                "blackberry tablet") : p("blackberry mobile") : i.windows() ? i.windowsTablet() ? p(
                    "windows tablet") : i.windowsPhone() ? p("windows mobile") : p("windows desktop") : i.fxos() ?
            i.fxosTablet() ? p("fxos tablet") : p("fxos mobile") : i.meego() ? p("meego mobile") : i.nodeWebkit() ?
                p("node-webkit") : i.television() ? p("television") : i.desktop() && p("desktop"), i.cordova() && p(
                    "cordova"), i.onChangeOrientation = function (t) {
    ...
    Object.prototype.hasOwnProperty.call(window, "onorientationchange") && (y = "orientationchange"),
        window.addEventListener ? window.addEventListener(y, v, !1) : window.attachEvent ? window.attachEvent(
            y, v) : window[y] = v, v(), i.type = m(["mobile", "tablet", "desktop"]), i.os = m(["ios",
                "iphone", "ipad", "ipod", "android", "blackberry", "windows", "fxos", "meego", "television"
            ]), b(), n.default = i
}, function (t, n, e) {
    "use strict";
    var o = e(26),
    ...
    t.exports = {
        createDialogElement: function (t) {
            (i = document.createElement("div")).className = "live2d-widget-dialog-container", i.style
                .transform = "scale(" + o.config.display.width / 250 + ")", (c = document.createElement(
                    "div")).className = "live2d-widget-dialog", i.appendChild(c), t.appendChild(i),
                r.L2Dwidget.emit("create-dialog", i), o.config.dialog.hitokoto && l()
        },
        displayDialog: u,
        hiddenDialog: s,
        alertText: f,
    ...
    t.exports = function (t) {
        return function (n, e) {
            var i, c, a = String(r(n)),
                u = o(e),
                s = a.length;
            return u < 0 || u >= s ? t ? "" : void 0 : (i = a.charCodeAt(u)) < 55296 || i > 56319 ||
                u + 1 === s || (c = a.charCodeAt(u + 1)) < 56320 || c > 57343 ? t ? a.charAt(u) : i :
                t ? a.slice(u, u + 2) : c - 56320 + (i - 55296 << 10) + 65536
        }
    }
}, function (t, n, e) {
    "use strict";
    ...
    var o = e(3),
        ...
        u = function () {
            var t, n = e(19)("iframe"),
                o = i.length;
            for (n.style.display = "none", e(34).appendChild(n), n.src = "javascript:", (t = n.contentWindow
                .document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), u = t.F; o--;)
                delete u.prototype[i[o]];
            return u()
        };
    t.exports = Object.create || function (t, n) {
        var e;
        return null !== t ? (a.prototype = o(t), e = new a, a.prototype = null, e[c] = t) : e = u(),
            void 0 === n ? e : r(e, n)
    }
}, function (t, n, e) {
    var o = e(10),
    ...
    t.exports = Object.getPrototypeOf || function (t) {
        return t = r(t), o(t, i) ? t[i] : "function" == typeof t.constructor && t instanceof t.constructor ?
            t.constructor.prototype : t instanceof Object ? c : null
    }
}, function (t, n, e) {
    var o = e(21);
    t.exports = function (t) {
    ...
    for (var o = e(59), r = e(31), i = e(5), c = e(1), a = e(4), u = e(8), s = e(0), f = s("iterator"), l =
        s("toStringTag"), p = u.Array, d = {
            CSSRuleList: !0,
    ...
    t.exports = e(30)(Array, "Array", function (t, n) {
        ...
        var t = this._t,
            n = this._k,
            e = this._i++;
        return !t || e >= t.length ? (this._t = void 0, r(1)) : r(0, "keys" == n ? e : "values" ==
            n ? t[e] : [e, t[e]])
    ...
    var o, r, i, c, a = e(17),
        ...
        M = !! function () {
            try {
                ...
                return (T || "function" == typeof PromiseRejectionEvent) && t.then(L) instanceof n && 0 !==
                    O.indexOf("6.6") && -1 === x.indexOf("Chrome/66")
            } catch (t) { }
        }(),
        A = function (t) {
            var n;
            ...
            if (!t._n) {
                ...
                b(function () {
                    for (var o = t._v, r = 1 == t._s, i = 0, c = function (n) {
                        var e, i, c, a = r ? n.ok : n.fail,
                            u = n.resolve,
                            s = n.reject,
                            f = n.domain;
                        try {
                            a ? (r || (2 == t._h && H(t), t._h = 1), !0 === a ? e = o : (f &&
                                f.enter(), e = a(o), f && (f.exit(), c = !0)), e ===
                                    n.promise ? s(P("Promise-chain cycle")) : (i = A(e)) ?
                                    i.call(e, u, s) : u(e)) : s(o)
                        } catch (t) {
                            f && !c && f.exit(), s(t)
                        }
                    }; e.length > i;) c(e[i++]);
        ...
        F = function (t) {
            m.call(u, function () {
                var n, e, o, r = t._v,
                    i = D(t);
                if (i && (n = w(function () {
                    T ? k.emit("unhandledRejection", r, t) : (e = u.onunhandledrejection) ?
                        e({
                            promise: t,
                            reason: r
                        }) : (o = u.console) && o.error && o.error(
    ...
    M || (j = function (t) {
        ...
        then: function (t, n) {
            ...
            return e.ok = "function" != typeof t || t, e.fail = "function" == typeof n && n,
                e.domain = T ? k.domain : void 0, this._c.push(e), this._a && this._a.push(
                    e), this._s && C(this, !1), e.promise
        },
        catch: function (t) {
        ...
        Promise: j
    }), e(24)(j, "Promise"), e(72)("Promise"), c = e(2).Promise, l(l.S + l.F * !M, "Promise", {
        reject: function (t) {
            var n = E(this);
    ...
    (n = t.exports = function (t, n, e, l, p) {
        ...
        if (i(m)) {
            for (d = a(t.length); d > g; g++)
                if ((y = n ? b(c(v = t[g])[0], v[1]) : b(t[g])) === s || y === f) return y
        } else
            for (h = m.call(t); !(v = h.next()).done;)
                if ((y = r(h, b, v.value, n)) === s || y === f) return y
    }).BREAK = s, n.RETURN = f
}, function (t, n, e) {
    var o = e(3);
    ...
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), e.p = o().replace(/[^/\\\\]+$/, ""), n.getCurrentPath = o
}, function (t, n, e) {
    "use strict";
    t.exports = {
        model: {
        ...
        function r(n, e) {
            for (var r in e)
                if (e.hasOwnProperty(r)) {
                    ...
                    var c = n[r];
                    null == c ? n[r] = i : "object" === (void 0 === c ? "undefined" : o(c)) && null !==
                        c && "object" === (void 0 === i ? "undefined" : o(i)) && null !== i && t(c, i)
                }
        }
        n = n || {};
